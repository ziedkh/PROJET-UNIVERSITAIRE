 ...
 * leur état passe de 0 Ã  1 lorsque le patient est guerris, la Fiche medicale est donc traité et
...
public class FicheMedicale implements Serializable{
    ...
    private String numDossier; //le numero dossier est un numero unique qui identifie une fiche medicale.
        public String getNumDossier() {return numDossier;}//il n'y a pas de setter car le numDossier est crée une fois et definitivement a la crÃ©ation de la fiche mÃ©dicale
    ...
    private Ordonnance ordonnance;//l'ordonnance peux etre null, elle est disponible lorsque le medecin l'a validÃ©    
    ...
    private Boolean etat;// l'etat de la fiche signifie si le patient a Ã©tÃ© traitÃ©(true) ou non(false)
    ...
    public FicheMedicale(String motif, Patient p, ObservableList<Symptome> liste){        
        ...
        dateEntree = new Date();
        /*
        createNumDossier() sert a creer le numero de dossier unique, c'est pour Ã§a que la fonction est private
        est qu'elle est uniquement appelée Ã  la création de la fiche médicale
        */
        createNumDossier();
